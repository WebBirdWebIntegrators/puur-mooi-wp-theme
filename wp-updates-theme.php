...
new WPUpdatesThemeUpdater_895( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_895') ) {
    class WPUpdatesThemeUpdater_895 {
